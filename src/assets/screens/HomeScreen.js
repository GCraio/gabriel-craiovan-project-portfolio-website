        ...
        <article className="experience">
          ...
          <ul className="technical_description">
            ...
            <li>
              ...
              problems and assist others in bringing their ideas to completion.
            </li>
            <li>
          ...
          <h4>Description:</h4>
          <p>
            NEED TO UPDATE I worked as a Junior Learning Management System (LMS)
            Analyst at Markanyx Solutions Inc. I was responsible for managing
            the LMS platform, creating and maintaining online courses, and
          ...
          <ul className="technical_description">
            <li>
              Developed and enhanced client-requested features and resolved bugs
              for web-based projects using PHP, JavaScript, CSS, HTML, and SQL.
            </li>
            <li>
          ...
          <h4>Description:</h4>
          <p>
            NEED TO UPDATE I worked as a Lead Software Developer at Romnica LTD.
            I led a team of software engineers in designing and building a
